                ...
                if (windowLayout != null) {
                    ...
                    { // Validate components list
                        ...
                        for (int c = 0; c < layoutItem.components.Length; ++c) {
                            ...
                            var comLock = com;
                            if ((windowLayout != com.windowLayout || windowLayout.HasLayoutElementByTagId(com.tag) == false) 
                                && windowLayout.layoutElements.Any(x => {
                                return x.innerLayout == comLock.windowLayout && x.innerLayout != null && x.innerLayout.HasLayoutElementByTagId(comLock.tag);
                            }) == false) {
